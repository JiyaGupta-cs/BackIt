  ...
  return (
    ...
    <div className="create-form">
      <form method="post" onSubmit={submitProjectData} name="projectForm">
        <h2 className="text-3xl text-center font-black">Create Project</h2>
        ...
        <input type="submit" className="submitButton p-2 bg-[#944EA5]" value="Submit" />
      </form>
    </div>
  );
}
