...
function PaymentModal(props) {
  ...
  // call function in the smart contract to send AIA token
  // to fund the project
  async function sendFund() {
    ...
    try {
      ...
      await txn.wait();
      alert(`${amount} AIA Succesfully funded`);
      ...
      console.log(error);
      console.log("................");
      alert("Error Sending AIA"+error.message);
    }
  }
    ...
    <div className="modal">
      ...
      <div className="modalContent">
        <div className="paymentForm">
          <label className="paymentLabel">Amount (AIA)</label>
          <input
            type="number"
            name="payment"
            id="payment"
