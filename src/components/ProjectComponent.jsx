    ...
    <>
      <div className="projectContainer">
        <div className="projectHeading">
          <h2 className="text-3xl text-center font-bold text-white">{projectDetails.projectName}</h2>
        </div>
        <div className="projectTopContainer">
          ...
          <div className="projectInformationContainer">
            ...
            <div className="fundingValue">
              <h2>{projectDetails.amountRaised / PRECISION} AIA</h2>
            </div>
            <p className="goalValueContainer text-white">
              pledged of{" "}
              <span className="goalValue">
                {projectDetails.fundingGoal / PRECISION} AIA
              </span>{" "}
              goal
            </p>
            <div className="supporterContainer">
              <h2 className="text-white">{projectDetails.contributors.length}</h2>
            </div>
            <p className="afterSupporterContainer text-white">backers</p>
            <div className="remainingDaysContainer text-white">
              <h2>{!isOver ? timerString : "Funding duration over!!"}</h2>
            </div>
            {!isOver && (
              <p className="afterRemainingDaysContainer text-white">
            ...
            {!isOver ? (!isOwner() && (
              <div className="supportButtonContainer">
                <button
                  className="supportButton bg-[#944EA5]"
        ...
        <div className="projectBottomContainer">
          <div className="aboutContainer">
            <h2 className="about text-white">About</h2>
            <p className="description text-white">{projectDetails.projectDescription}</p>
          </div>
        ...
        <div className="contributorHeader text-white">Contributors</div>
        <div className="contributors">
          <div className="tableRow header bg-[#944EA5] border-[#944EA5]">
